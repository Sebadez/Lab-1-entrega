...
public class Calculadorass extends javax.swing.JFrame {
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        ...
        c=Double.parseDouble(jTextField1.getText());
        t=Double.parseDouble(jTextField1.getText());
        v=Float.parseFloat(jTextField1.getText());
        switch(signo){
            case "+":
               jTextField1.setText(Float.toString(objeto1.suma(a,b))); 
               break;
            case "-":
               jTextField1.setText(Float.toString(objeto1.resta(a,b))); 
               break;
            case "*":
               jTextField1.setText(Float.toString(objeto1.multi(a,b))); 
               break;
            case "/":
               jTextField1.setText(Float.toString(objeto1.div(a, b))); 
               break;
            case "^":
               jTextField1.setText(Double.toString(objeto1.potencia(n, m))); 
               break;   
             case "√":
               jTextField1.setText(Double.toString(objeto1.raiz(n, m))); 
               break; 
            case "Sen":
               jTextField1.setText(Double.toString(objeto1.seno(s))); 
               break;
            case "Cos":
               jTextField1.setText(Double.toString(objeto1.coseno(c))); 
               break;
            case "Tan":
               jTextField1.setText(Double.toString(objeto1.tangente(t))); 
               break;  
            case "Iva": 
               jTextField1.setText(Float.toString(objeto1.iva(i,v)));
        }   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculadorass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculadorass().setVisible(true);
            }
        });
    }
